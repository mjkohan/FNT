...
export default function CryptoCard({ name, image, price, priceChange, marketCapRank, symbol }: CryptoCardProps) {
  ...
  return (
    <Card className="flex cursor-pointer flex-col items-center justify-center p-6 shadow-lg rounded-2xl bg-card/90 hover:scale-105 transition-transform duration-200 relative max-h-[340px]">
      {/* Market Cap Rank */}
