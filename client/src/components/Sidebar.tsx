...
import { Home, Newspaper, Star, User, Menu } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-[9999] p-2 rounded-lg bg-card/90 border border-border/50 shadow hover:bg-muted/40 transition"
